...
<title>APRIL PROCURIMENT CHECK</title>
...
<div id="body">
<form name = "myform"  action = "AprilProcurimentDatabaseEntry" method = "post">
...
<tr>
<th colspan="2" class="h">PROCUREMENT IN APRIL </th>
</tr>
<tr>
...
<div><a href="AprilProcurement1st.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify PROCURIMENT Details"/></a>
