...
<title>AUGUST PROCURIMENT CHECK</title>
...
<div id="body">
<form name = "myform"  action = "AugustProcurimentDatabaseEntry" method = "post">
...
<tr>
<th colspan="2" class="h">PROCUREMENT IN AUGUST </th>
</tr>
<tr>
...
<div><a href="Augustprocuirement1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify PROCURIMENT Details"/></a>
