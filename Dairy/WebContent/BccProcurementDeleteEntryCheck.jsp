...
<title>BCC PROCUREMENT DELETE CHECKING PANEL</title>
...
<div id="body">
<form name = "myform"  action = "BccProcurementDeleteDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:250px;">BCC PROCUREMENT DELETING PANEL</u></font></div>
<div style="color:brown;position:relative;left:430px;font-family:calibri;font-style:italic;text-decoration: underline;">Time of the Account login is</div>
<div  id= "demo" style="color:blue;position:relative;left:330px;font-family:TimesNewRoman;font-style:italic;margin-top:10pt;margin-bottom:10pt">
...
<tr>
<th colspan="3" align="center">DELETE BCC OF ITS DATE OF ENTRY FROM BCC PROCUREMENT</th>
</tr>
<tr>
<th colspan="3" align="center">ENTER BCC AND DATE OF ENTRY REQUIRED TO DELETE</th>
</tr>
