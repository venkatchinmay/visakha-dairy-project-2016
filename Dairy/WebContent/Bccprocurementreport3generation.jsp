...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
		...
		//********************************************************************************//
		 ...
		 k1 = result.getString("TOTAL_BM_AVERAGE");
		...
		//********************************************************************************//
					while(result.next()) { 
						k2 = result.getString("TOTAL_CM_AVERAGE");
		 }
		...
		//********************************************************************************//
					while(result.next()) { 
		 k3 = result.getString("TOTAL_AVERAGE");
		...
		//********************************************************************************//
					while(result.next()) { 
		 k4 = result.getString("TOTAL_BM_AVERAGE");
		...
		//********************************************************************************//
					while(result.next()) { 
		 k5 = result.getString("TOTAL_CM_AVERAGE");
		 }
		...
		//********************************************************************************//
					while(result.next()) { 
		 k6 = result.getString("TOTAL_AVERAGE");
					...
					//********************************************************************************//
								while(result.next()) { 
					 k7 = result.getString("TOTAL_BM_AVERAGE");
					...
					//********************************************************************************//
								while(result.next()) { 
					 k8 = result.getString("TOTAL_CM_AVERAGE");
					 }
					...
					//********************************************************************************//
								while(result.next()) { 
					 k9 = result.getString("TOTAL_AVERAGE");
								...
								//********************************************************************************//
											while(result.next()) { 
								k10 = result.getString("TOTAL_BM_AVERAGE");
								...
								//********************************************************************************//
											while(result.next()) { 
								 k11 = result.getString("TOTAL_CM_AVERAGE");
								 }
								...
								//********************************************************************************//
											while(result.next()) { 
												k12 = result.getString("TOTAL_AVERAGE");
										...
										//********************************************************************************//
													while(result.next()) { 
										k13 = result.getString("TOTAL_BM_AVERAGE");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k14 = result.getString("TOTAL_CM_AVERAGE");
										 }
										...
										//********************************************************************************//
													while(result.next()) { 
										 k15 = result.getString("TOTAL_AVERAGE");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k16 = result.getString("TOTAL_BM_AVERAGE");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k17 = result.getString("TOTAL_CM_AVERAGE");
										 }
										...
										//********************************************************************************//
													while(result.next()) { 
										 k18 = result.getString("TOTAL_AVERAGE");
													...
													//********************************************************************************//
																while(result.next()) { 
													 k19 = result.getString("TOTAL_BM_AVERAGE");
													...
													//********************************************************************************//
																while(result.next()) { 
													k20 = result.getString("TOTAL_CM_AVERAGE");
													 }
													...
													//********************************************************************************//
																while(result.next()) { 
													 k21 = result.getString("TOTAL_AVERAGE");
																...
																//********************************************************************************//
																			while(result.next()) { 
																 k22 = result.getString("TOTAL_BM_AVERAGE");
																...
																//********************************************************************************//
																			while(result.next()) { 
																 k23 = result.getString("TOTAL_CM_AVERAGE");
																 }
																...
																//********************************************************************************//
																			while(result.next()) { 
																 k24 = result.getString("TOTAL_AVERAGE");
																}
																			//**********************************************************************//
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k25 = result.getString("TOTAL_BM_AVERAGE");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k26 = result.getString("TOTAL_CM_AVERAGE");
																		 }
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k27 = result.getString("TOTAL_AVERAGE");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k28 = result.getString("TOTAL_BM_AVERAGE");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k29 = result.getString("TOTAL_CM_AVERAGE");
																		 }
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		k30 = result.getString("TOTAL_AVERAGE");
																					...
																					//********************************************************************************//
																								while(result.next()) { 
																					 k31 = result.getString("TOTAL_BM_AVERAGE");
																					...
																					//********************************************************************************//
																								while(result.next()) { 
																					 k32 = result.getString("TOTAL_CM_AVERAGE");
																					 }
																					...
																					//********************************************************************************//
																								while(result.next()) { 
																					k33 = result.getString("TOTAL_AVERAGE");
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								k34 = result.getString("TOTAL_BM_AVERAGE");
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								 k35 = result.getString("TOTAL_CM_AVERAGE");
																								 }
					...
					//*******************************************************************************//
																											while(result.next()) { 
																								 k36 = result.getString("TOTAL_AVERAGE");
																								 
																								//********************************************************************************************************************//
																								  
																								    prest = con.prepareStatement("SELECT SUM(BCC_BM_AVERAGE)TOTAL_BM_AVERAGE FROM bcc_procuriment  WHERE BCC= ? ORDER BY BCC");
																									prest.setString(1, Y1);	
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								k37 = result.getString("TOTAL_BM_AVERAGE");
																								 
																								}
																							 
																								    prest = con.prepareStatement("SELECT SUM(BCC_CM_AVERAGE)TOTAL_CM_AVERAGE FROM bcc_procuriment WHERE BCC= ?  ORDER BY BCC");
																									prest.setString(1, Y1);	
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								 k38 = result.getString("TOTAL_CM_AVERAGE");
																								 }
																								
																								    prest = con.prepareStatement("SELECT SUM(BCC_TOTAL_AVERAGE)TOTAL_AVERAGE FROM bcc_procuriment WHERE BCC= ? ORDER BY BCC");
																									prest.setString(1, Y1);	
					...
					//*******************************************************************************//
																											while(result.next()) { 
																								 k39 = result.getString("TOTAL_AVERAGE");
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">ANNUM LIST OF BCC PROCUREMENT DETAILS</div><br/>
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
<th>ANNUM</th>
<th>OVERALL TOTAL B.M AVERAGE</th>
<th>OVERALL TOTAL C.M AVERAGE</th>
<th>OVERALL TOTAL OF TOTAL AVERAGE</th>
</tr>
<tr>
<th>YEAR WISE</th>
<th><%=k37 %></th>
