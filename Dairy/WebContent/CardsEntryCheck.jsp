...
<div id="body">
<form name = "myform"  action = "CardsDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:450px;">CARD ENTRY DETAILS</u></font></div>
...
<tr>
<th colspan="2" class="h">CENTER DETAILS</th>
</tr>
<tr>
...
<div><a href="Cards.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify CARDS Details"/></a>
...
<input style="float:left;position:relative;left:500px;margin:15px" type="submit" onclick="return confirm('Make Sure That Above Mentioned Details Are Correct Once you submitted it will NOT BE MODIFIED')" name="pay fee" value="Enter CARD Details Successfully" />
</div>
</form>
</div>
