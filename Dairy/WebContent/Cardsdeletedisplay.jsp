...
<title>CARDS DELETION PANEL</title>
</head>
<body>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM cards WHERE CENTERNAME=? ORDER BY BCC");
...
<br/><br/>	
<div>
<form name = "myform"  action = "Cardsdeletedoperation.jsp" method = "post">
