...
<title>CATTLE INSURANCE PANEL CHECK</title>
...
<div id="body">
<form name = "myform"  action = "CattleinsuranceDataBaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:350px;">CATTLE INSURANCE ENTRY</u></font></div>
...
<tr>
<th colspan="2" class="h">CENTERDETAILS </th>
</tr>
<tr>
...
<tr>
<th colspan="2" class="h">ANIMALS</th>
</tr>
<tr>
<th class="n"> BUFFALOS </th>
...
<tr>
<th colspan="2" class="h">INSURANCE DETAILS</th>
</tr>
<tr>
<th class="n">TOTAL PREMIUM </th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y6 %> </th>
</tr>
<tr>
<th colspan="2" class="h">BANK DETAILS</th>
</tr>
<tr>
<th class="n">BANK NAME</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y7 %> </th>
</tr>
<tr>
<th class="n">BANK LOCATION</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y8 %> </th>
</tr>
<tr>
<th class="n">DD NUMBER</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y9 %> </th>
</tr><tr>
<tr>
<th class="n">DD AMOUNT</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y10 %> </th>
</tr>
<tr>
<th class="n">DD DATE</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y11 %> </th>
</tr><tr>
<tr>
<th class="n">DD MONTH</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y12 %> </th>
</tr>
<tr>
<th class="n">DATE OF ENTRY</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y13 %> </th>
</tr>
</table>     
</div>

<div><a href="Cattleinsuranceentry1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify CATTLE INSURANCE Details"/></a>
...
<input style="float:left;position:relative;left:500px;margin:15px" type="submit" onclick="return confirm('Make Sure That Above Mentioned Details Are Correct Once you submitted it will NOT BE MODIFIED')" name="pay fee" value="Enter CATTLE INSURANCE Details Successfully" />
</div>
</form>
</div>
