...
<title>CATTLE INSURANCE DELETE CHECKING PANEL</title>
...
<div id="body">
<form name = "myform"  action = "CattleinsuranceDeleteDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:330px;">CATTLE INSURANCE DELETING PANEL</u></font></div>
...
<tr>
<th colspan="3" align="center">DELETE CENTER DATA OF PARTICULAR DATE OF ENTRY FROM CATTLE INSURANCE PANELS</th>
</tr>
<tr>
<th colspan="3" align="center">ENTER CENTER DATA AND DATE OF ENTRY REQUIRED TO DELETE</th>
</tr>
...
<div><a href="CattleinsuranceDelete.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify Center Name"/></a>
