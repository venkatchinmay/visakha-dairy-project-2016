...
<p style="color:black;font-family:calibri;font-weight:bold;">DD MONTH : <%=Y2 %></p>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM cattle_i WHERE BCC=? AND CI_DDMONTH=? ORDER BY BCC");
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">AGGREGATE TOTALS OF CATTLE INSURANCE DETAILS ON THE PARTICULAR MONTH(DD MONTH)</div><br/>	
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
