...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			//**********************************************************************//
              ...
              String Y2 ="APRIL";
		    prest = con.prepareStatement("SELECT SUM(CI_BUFFALOS)TOTAL_BUFFALOS FROM cattle_i  WHERE BCC=? AND CI_DDMONTH=? ORDER BY BCC");
		...
		//********************************************************************************//
		 ...
		 System.out.println("hello"+k1);
		    ...
		    prest = con.prepareStatement("SELECT SUM(CI_COWS)TOTAL_COWS FROM cattle_i WHERE BCC=? AND CI_DDMONTH=? ORDER BY BCC");
			prest.setString(1, Y1);	
			prest.setString(2, Y2);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
		    ...
		    prest = con.prepareStatement("SELECT SUM(CI_TOTALPREMIUM)TOTAL_PREMIUM FROM cattle_i WHERE BCC=? AND CI_DDMONTH=? ORDER BY BCC");
			prest.setString(1, Y1);	
			prest.setString(2, Y2);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
					while(result.next()) { 
		 k3 = result.getString("TOTAL_PREMIUM");
		
					}
					 prest = con.prepareStatement("SELECT SUM(CI_DDAMOUNT)TOTAL_AMOUNT FROM cattle_i WHERE BCC=? AND CI_DDMONTH=?  ORDER BY BCC");
						prest.setString(1, Y1);	
						prest.setString(2, Y2);	
						result = prest.executeQuery();
							System.out.println("Querie Successfully Executed");
					//********************************************************************************//
								while(result.next()) { 
					 k37 = result.getString("TOTAL_AMOUNT");
		...
		//********************************************************************************//
					while(result.next()) { 
		 k6 = result.getString("TOTAL_PREMIUM");
				...
				//********************************************************************************//
							while(result.next()) { 
				 k38 = result.getString("TOTAL_AMOUNT");
					...
					//********************************************************************************//
								while(result.next()) { 
					 k9 = result.getString("TOTAL_PREMIUM");
							...
							//********************************************************************************//
							 ...
							 k39 = result.getString("TOTAL_AMOUNT");
								...
								//********************************************************************************//
											while(result.next()) { 
												k12 = result.getString("TOTAL_PREMIUM");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k40 = result.getString("TOTAL_AMOUNT");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k15 = result.getString("TOTAL_PREMIUM");
												...
												//********************************************************************************//
															while(result.next()) { 
												 k41 = result.getString("TOTAL_AMOUNT");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k18 = result.getString("TOTAL_PREMIUM");
												...
												//********************************************************************************//
															while(result.next()) { 
												 k42 = result.getString("TOTAL_AMOUNT");
													...
													//********************************************************************************//
																while(result.next()) { 
													 k21 = result.getString("TOTAL_PREMIUM");
															...
															//********************************************************************************//
																		while(result.next()) { 
															 k43 = result.getString("TOTAL_AMOUNT");
																...
																//********************************************************************************//
																			while(result.next()) { 
																 k24 = result.getString("TOTAL_PREMIUM");
																}
																			prest = con.prepareStatement("SELECT SUM(CI_DDAMOUNT)TOTAL_AMOUNT FROM cattle_i WHERE BCC=? AND CI_DDMONTH=?  ORDER BY BCC");
																			prest.setString(1, Y1);	
																			prest.setString(2, Y9);	
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k44 = result.getString("TOTAL_AMOUNT");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k27 = result.getString("TOTAL_PREMIUM");
																				...
																				//********************************************************************************//
																							while(result.next()) { 
																				 k45 = result.getString("TOTAL_AMOUNT");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		k30 = result.getString("TOTAL_PREMIUM");
																				...
																				//********************************************************************************//
																							while(result.next()) { 
																				 k46 = result.getString("TOTAL_AMOUNT");
																					...
																					//********************************************************************************//
																								while(result.next()) { 
																					k33 = result.getString("TOTAL_PREMIUM");
																							...
																							//********************************************************************************//
																										while(result.next()) { 
																							 k47 = result.getString("TOTAL_AMOUNT");
					...
					//*******************************************************************************//
																											while(result.next()) { 
																								 k36 = result.getString("TOTAL_PREMIUM");
																											}
																											prest = con.prepareStatement("SELECT SUM(CI_DDAMOUNT)TOTAL_AMOUNT FROM cattle_i WHERE BCC=? AND CI_DDMONTH=?  ORDER BY BCC");
																											prest.setString(1, Y1);	
																											prest.setString(2, Y13);	
																										...
																										//********************************************************************************//
																													while(result.next()) { 
																										 k48 = result.getString("TOTAL_AMOUNT");
																										
																													}
																								 
																								//********************************************************************************************************************//
																								  
																								    prest = con.prepareStatement("SELECT SUM(CI_BUFFALOS)TOTAL_BUFFALOS FROM cattle_i  WHERE BCC= ? ORDER BY BCC");
																									prest.setString(1, Y1);	
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								k49 = result.getString("TOTAL_BUFFALOS");
																								 
																								}
																							 
																								    prest = con.prepareStatement("SELECT SUM(CI_COWS)TOTAL_COWS FROM cattle_i WHERE BCC= ?  ORDER BY BCC");
																									prest.setString(1, Y1);	
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								 k50 = result.getString("TOTAL_COWS");
																								 }
																								
																								    prest = con.prepareStatement("SELECT SUM(CI_TOTALPREMIUM)TOTAL_PREMIUM FROM cattle_i WHERE BCC=? ORDER BY BCC");
																									prest.setString(1, Y1);	
					...
					//*******************************************************************************//
																											while(result.next()) { 
																								 k51 = result.getString("TOTAL_PREMIUM");
																								 
																											}
																											prest = con.prepareStatement("SELECT SUM(CI_DDAMOUNT)TOTAL_AMOUNT FROM cattle_i WHERE BCC=? ORDER BY BCC");
																											prest.setString(1, Y1);	
																										...
																										//********************************************************************************//
																													while(result.next()) { 
																										 k52 = result.getString("TOTAL_AMOUNT");
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">MONTHLY(DD MONTH) LIST OF CATTLE INSURANCE DETAILS</div><br/>
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">ANNUM LIST OF CATTLE INSURANCE DETAILS</div><br/>
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
<th>ANNUM</th>
<th>TOTAL NUMBER OF BUFFALOS </th>
