...
<div id="body">
<form name = "myform"  action = "CenterDeleteDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:400px;">CENTER DETAILS DELETING PANEL</u></font></div>
<div style="color:brown;position:relative;left:530px;font-family:calibri;font-style:italic;text-decoration: underline;">Time of the Account login is</div>
...
<tr>
<th colspan="3">DELETE CENTER DATA FROM CENTER ENTRY ,PROCUREMENT AND WITHHELPPRICE PANELS</th>
</tr>
<tr>
<th colspan="3">ENTER CENTER DATA REQUIRED TO DELETE</th>
</tr>
