...
<title>JOINT ACCOUNT AND PROFIT DETAILS DELETE GENERATION PANEL</title>
</head>
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">DELETION LIST OF JOINT ACCOUNT AND PROFIT DETAILS</div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			prest = con.prepareStatement("SELECT * FROM center_profitdetails WHERE CENTERNAME=? AND MONTHPRO = ?  ORDER BY BCC");
...
<div>
<form name = "myform"  action = "Centerprofitdeletedoperation.jsp" method = "post">

<div>
<a href="CenterprofitdetailsDelete.html"><input style="float:left;clear:left;position:relative;left:100px;margin:15px" type="button" value="Modify Center Name"/></a>
