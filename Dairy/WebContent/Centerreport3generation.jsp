...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">LIST OF STAFF DETAILS</div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT  BCC,CENTERCODE,CENTERNAME,PS,HELPER1,HELPER2,HELPER3 FROM center_details WHERE BCC=? ORDER BY CENTERNAME");
		...
		//********************************************************************************//
					while(result.next()) {
					 ...
					 String k4 = result.getString("PS");
					 String k5 = result.getString("HELPER1");
					 String k6 = result.getString("HELPER2");
					 String k7 = result.getString("HELPER3");
