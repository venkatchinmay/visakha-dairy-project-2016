...
<title>CENTER DETAILS RECEIPT GENERATION PANEL</title>
</head>
<body>
...
%>
<p style="color:black;font-family:calibri;font-weight:bold;">BANK NAME : <%=Y1 %></p>
<p style="color:black;font-family:calibri;font-weight:bold;">BANK LOCATION : <%=Y2 %></p>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM center_details  WHERE BANKNAME=? AND BANKLOCATION=? ORDER BY BCC");
