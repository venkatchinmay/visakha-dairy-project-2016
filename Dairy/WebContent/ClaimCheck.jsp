...
<title>CLAIMS ENTRY PANEL CHECK</title>
...
<div id="body">
<form name = "myform"  action = "ClaimDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:480px;">CLAIMS ENTRY</u></font></div>
...
<tr>
<th colspan="2" class="h">CLAIM DETAILS</th>
</tr>
<tr>
<th class="n">GENERAL NUMBER</th>
<th style="text-transform: uppercase;color:black;font-family:times new roman;"><%=  Y6 %> </th>
</tr>
<tr>
<th class="n">PRODUCER NAME</th>
...
<div><a href="Claimentry1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify CLAIMS ENTRY Details"/></a>
...
<input style="float:left;position:relative;left:500px;margin:15px" type="submit" onclick="return confirm('Make Sure That Above Mentioned Details Are Correct Once you submitted it will NOT BE MODIFIED')" name="pay fee" value="Enter CLAIMS ENTRY Details Successfully" />
</div>
</form>
</div>
