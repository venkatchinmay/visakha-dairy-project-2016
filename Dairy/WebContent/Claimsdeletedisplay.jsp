...
<title>CLAIM DELETION PANEL</title>
</head>
<script type="text/javascript">
function call(){
	var person = prompt("PLEASE ENTER GENERAL NUMBER TO DELETE");
	if(person!=null){window.location.replace("claimsinnerdeletion.jsp?person="+person);}
}
</script>
<body>
<div id=”header” align="center"><img src="logo.jpg"alt="source"/>
<p style="color:black;font-size:15pt;font-weight:bold;font-family: calibri">VISAKHA DAIRY DELETION PANEL</p>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM claim_i WHERE CENTERNAME=? AND CL_DATE_OF_ENTRY = ? ORDER BY BCC");
...
<div>
<form name = "myform"  action = "Claimsdeletedoperation.jsp" method = "post">

<div><a href="ClaimsDelete.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify Center Name"/></a>
