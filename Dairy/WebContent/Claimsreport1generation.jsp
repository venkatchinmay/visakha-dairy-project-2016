...
<title>CLAIM RECEIPTS GENERATION PANEL</title>
</head>
<body>
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">DAILY LIST OF CLAIMS DETAILS</div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM claim_i WHERE CL_DATE_OF_ENTRY=? ORDER BY BCC");
		...
		//********************************************************************************//
					while(result.next()) {
					 ...
					 String k4 = result.getString("CL_BUFFALOS");
					 String k5 = result.getString("CL_COWS");
					 String k6 = result.getString("CL_GENERALNUMBER");
					 String k7 = result.getString("CL_PRODUCERNAME");
					 String k8 = result.getString("CI_AMOUNT");
					 String k9 = result.getString("CL_DATEOFDEATH");
					 String k10 = result.getString("CL_ENTRYMONTH");
					 String k11 = result.getString("CL_DATE_OF_ENTRY");
...
<br/>	
<hr>	
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">AGGREGATE TOTALS OF CLAIMS ON THE PARTICULAR DAY</div><br/>	
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
...
try{
		    ...
		    prest = con.prepareStatement("SELECT SUM(CL_BUFFALOS)TOTAL_BUFFALOS FROM claim_i WHERE CL_DATE_OF_ENTRY=? ORDER BY BCC");
			prest.setString(1, Y1);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
...
<%		 
		    prest = con.prepareStatement("SELECT SUM(CL_COWS)TOTAL_COWS FROM claim_i WHERE CL_DATE_OF_ENTRY=? ORDER BY BCC");
			prest.setString(1, Y1);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
...
<%		 
		    prest = con.prepareStatement("SELECT SUM(CI_AMOUNT)TOTAL_AMOUNT FROM claim_i WHERE CL_DATE_OF_ENTRY=? ORDER BY BCC");
			prest.setString(1, Y1);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
