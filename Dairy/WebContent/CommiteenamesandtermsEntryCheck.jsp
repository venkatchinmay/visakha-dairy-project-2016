...
<title>CENTER COMMITTE DETAILS ENTRY CHECKING PANEL</title>
...
<div id="body">
<form name = "myform"  action = "CommiteenamesandtermsDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:350px;">CENTER COMMITTE DETAILS ENTRY</u></font></div>
...
<input style="float:left;position:relative;left:500px;margin:15px" type="submit" onclick="return confirm('Make Sure That Above Mentioned Details Are Correct Once you submitted it will NOT BE MODIFIED')" name="pay fee" value="Enter COMMITEE Details Successfully" />
</div>
</form>
</div>
