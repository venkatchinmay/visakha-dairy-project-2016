...
<p style="color:black;font-family:calibri;font-weight:bold;">DIRECTOR TERM : <%=Y1 %></p>
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">LIST OF DIRECTORS BASED ON DIRECTOR TERM</div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT BCC,CENTERCODE,CENTERNAME,DIRECTOR_NAMES,DIRECTOR_TERMS FROM directors WHERE DIRECTOR_TERMS=? ORDER BY CENTERNAME");
		...
		//********************************************************************************//
					while(result.next()) {
						String k1 = result.getString("BCC");
						 ...
						 String k4 = result.getString("DIRECTOR_NAMES");
						 String k5 = result.getString("DIRECTOR_TERMS");
