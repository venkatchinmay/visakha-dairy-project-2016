...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">LIST OF ALL PRESIDENTS </div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT BCC,CENTERCODE,CENTERNAME,MPI_MPAC,PRESIDENT_GROUPMEMBER,PRESIDENT_NAME,PRESIDENT_TERM FROM commitee ORDER BY CENTERNAME");
