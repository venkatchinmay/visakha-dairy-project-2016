...
<div id="body">
<div style=" background-color:#FFC0CB;color:#FF0000;width:100%;height:3cm;margin-top:2cm;margin-bottom:2cm;text-align: center;padding-top:1cm;padding-bottom:1cm;font-size:30pt;text-transform:uppercase;"> PLEASE CHECK YOUR INPUTS IT IS NOT PRESENT IN DATABASE TO DELETE IT </div>
</div>
