...
<div id="body">
<div style=" background-color:#FFC0CB;color:#FF0000;width:100%;height:3cm;margin-top:2cm;margin-bottom:2cm;text-align: center;padding-top:1cm;padding-bottom:1cm;font-size:30pt;text-transform:uppercase;"> PLEASE ENTER DATE IN CORRECT FORMAT DD/MM/YYYY; DATE:1-31;MONTH:1-12 </div>
</div>
