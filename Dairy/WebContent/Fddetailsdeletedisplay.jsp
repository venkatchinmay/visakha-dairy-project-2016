...
function call(){
	var person = prompt("PLEASE ENTER BOND NUMBER REQUIRED TO DELETE");
	if(person!=null){window.location.replace("FdDetailsinnerdeletion.jsp?person="+person);}
}
</script>
<body>
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">DELETION LIST OF FD DETAILS</div><br/>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			prest = con.prepareStatement("SELECT * FROM fd_details WHERE CENTERNAME=?  ORDER BY BCC");
		...
		//********************************************************************************//
					while(result.next()) {
						 ...
						 String k4 = result.getString("BONDNUMBER");
						 String k5 = result.getString("BONDVALUE");
						 String k6 = result.getString("BONDDATE");
						 String k7 = result.getString("MATUREVALUE");
						 String k8 = result.getString("MATUREDATE");
...
<div>
<form name = "myform"  action = "FdDetailsdeletedoperation.jsp" method = "post">

<div>
<a href="FDDetailsDelete.html"><input style="float:left;clear:left;position:relative;left:100px;margin:15px" type="button" value="Modify Center Name"/></a>
