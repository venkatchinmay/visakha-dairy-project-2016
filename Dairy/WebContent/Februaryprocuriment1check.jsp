...
<title>FEBRUARY PROCURIMENT CHECK</title>
...
<div id="body">
<form name = "myform"  action = "FebruaryProcurimentDatabaseEntry" method = "post">
...
<tr>
<th colspan="2" class="h">PROCUREMENT IN FEBRUARY </th>
</tr>
<tr>
...
<div><a href="Febrauaryprocuirement1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify PROCURIMENT Details"/></a>
