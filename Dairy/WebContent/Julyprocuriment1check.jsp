...
<title>JULY PROCURIMENT CHECK</title>
...
<div id="body">
<form name = "myform"  action = "JulyProcurimentDatabaseEntry" method = "post">
...
<tr>
<th colspan="2" class="h">PROCUREMENT IN JULY </th>
</tr>
<tr>
...
<div><a href="Julyprocuirement1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify PROCURIMENT Details"/></a>
