...
<title>SUCCESSFULLY DELETED PAGE</title>
...
<div id="body">
<div style=" background-color:#98FB98;color:#228B22;width:100%;height:3cm;margin-top:2cm;margin-bottom:2cm;text-align: center;padding-top:1cm;padding-bottom:1cm;font-size:30pt;text-transform:uppercase;">ENTIRE DATA BASE SUCCESSFULLY DELETED </div>
</div>
