...
<div id="body">
<div style=" background-color:#98FB98;color:#228B22;width:100%;height:10cm;margin-top:2cm;margin-bottom:2cm;text-align: center;padding-top:1cm;padding-bottom:1cm;font-size:30pt;text-transform:uppercase;"><p>CENTER NAME :<%= t %></p><p> BONDNUMBER :<%= t2 %></p><p>SUCCESSFULLY DELETED</p></div>
</div>
