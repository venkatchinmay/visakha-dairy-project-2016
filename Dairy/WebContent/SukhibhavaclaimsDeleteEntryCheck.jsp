...
<title>SUKHIBHAVA CLAIMS DELETE CHECKING PANEL</title>
...
<div id="body">
<form name = "myform"  action = "SukhibhavaclaimsDeleteDatabaseEntry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:330px;">SUKHIBHAVA CLAIMS DELETING PANEL</u></font></div>
...
<tr>
<th colspan="3" align="center">DELETE CENTER DATA OF PARTICULAR DATE OF ENTRY FROM SUKHIBHAVA CLAIMS PANELS</th>
</tr>
<tr>
