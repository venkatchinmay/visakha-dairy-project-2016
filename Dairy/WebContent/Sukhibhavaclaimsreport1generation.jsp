...
<title>SUKHIBHAVA CLAIM RECEIPTS GENERATION PANEL</title>
</head>
<body>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			////////////////////////////////////////////////////
			prest = con.prepareStatement("SELECT * FROM sukhclaim_i WHERE SUCL_DATE_OF_ENTRY=? ORDER BY BCC");
...
<br/>	
<hr>	
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">AGGREGATE TOTALS OF SUKHIBHAVA CLAIMS ON THE PARTICULAR DAY</div><br/>	
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
...
try{
		    ...
		    prest = con.prepareStatement("SELECT COUNT(*)NO_OF_DEATHMEMBERS FROM sukhclaim_i WHERE SUCL_DATE_OF_ENTRY=?");
			prest.setString(1, Y1);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
...
<%		 
		    prest = con.prepareStatement("SELECT SUM(SUCI_AMOUNT)TOTAL_AMOUNT FROM sukhclaim_i WHERE SUCL_DATE_OF_ENTRY=?");
			prest.setString(1, Y1);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		//********************************************************************************//
