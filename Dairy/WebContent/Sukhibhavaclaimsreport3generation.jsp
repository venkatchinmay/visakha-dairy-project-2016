...
<title>SUKHIBHAVA CLAIMS RECEIPTS GENERATION PANEL</title>
</head>
<body>
...
//*******************STEP:3 ESTABLISH CONNECTION TO THE DRIVER*******************************//
			...
			//**********************************************************************//
              ...
              String Y2 ="APRIL";
		    prest = con.prepareStatement("SELECT COUNT(*)NO_OF_DEATHMEMBERS FROM sukhclaim_i WHERE BCC=? AND SUCL_ENTRYMONTH=? ORDER BY BCC");
		...
		//********************************************************************************//
		 ...
		 k1 = result.getString("NO_OF_DEATHMEMBERS");
		 System.out.println("hello"+k1);
		    ...
		    prest = con.prepareStatement("SELECT SUM(SUCI_AMOUNT)TOTAL_AMOUNT FROM sukhclaim_i WHERE BCC=? AND SUCL_ENTRYMONTH=? ORDER BY BCC");
			prest.setString(1, Y1);	
			prest.setString(2, Y2);	
			result = prest.executeQuery();
				System.out.println("Querie Successfully Executed");
		...
		//********************************************************************************//
					while(result.next()) { 
		 k4 = result.getString("NO_OF_DEATHMEMBERS");
		...
		//********************************************************************************//
		 ...
		 k6 = result.getString("TOTAL_AMOUNT");
					...
					//********************************************************************************//
								while(result.next()) { 
					 k7 = result.getString("NO_OF_DEATHMEMBERS");
					...
					//********************************************************************************//
					 ...
					 k9 = result.getString("TOTAL_AMOUNT");
								...
								//********************************************************************************//
											while(result.next()) { 
								k10 = result.getString("NO_OF_DEATHMEMBERS");
								...
								//********************************************************************************//
										...
										//********************************************************************************//
													while(result.next()) { 
										k13 = result.getString("NO_OF_DEATHMEMBERS");
										...
										//********************************************************************************//
													while(result.next()) { 
										 k16 = result.getString("NO_OF_DEATHMEMBERS");
										...
										//********************************************************************************//
										 ...
										 k18 = result.getString("TOTAL_AMOUNT");
													...
													//********************************************************************************//
																while(result.next()) { 
													 k19 = result.getString("NO_OF_DEATHMEMBERS");
													...
													//********************************************************************************//
													 ...
													 k21 = result.getString("TOTAL_AMOUNT");
																...
																//********************************************************************************//
																			while(result.next()) { 
																 k22 = result.getString("NO_OF_DEATHMEMBERS");
																...
																//********************************************************************************//
																 ...
																 k24 = result.getString("TOTAL_AMOUNT");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k25 = result.getString("NO_OF_DEATHMEMBERS");
																		...
																		//********************************************************************************//
																					while(result.next()) { 
																		 k28 = result.getString("NO_OF_DEATHMEMBERS");
																		...
																		k30 = result.getString("TOTAL_AMOUNT");
																					...
																					//********************************************************************************//
																								while(result.next()) { 
																					 k31 = result.getString("NO_OF_DEATHMEMBERS");
																					...
																					k33 = result.getString("TOTAL_AMOUNT");
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								k34 = result.getString("NO_OF_DEATHMEMBERS");
					...
					//*******************************************************************************//
																								...
																								//********************************************************************************************************************//
																								    ...
																								    prest = con.prepareStatement("SELECT COUNT(*)NO_OF_DEATHMEMBERS FROM sukhclaim_i WHERE BCC=? ORDER BY BCC");
																									prest.setString(1, Y1);	
																								...
																								//********************************************************************************//
																											while(result.next()) { 
																								k37 = result.getString("NO_OF_DEATHMEMBERS");
																								 
																								}
																							 
																								   //**********************************************************************//
																								   
																								    prest = con.prepareStatement("SELECT SUM(SUCI_AMOUNT)TOTAL_AMOUNT FROM sukhclaim_i WHERE BCC=?  ORDER BY BCC");
																									prest.setString(1, Y1);	
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">MONTHLY LIST OF SUKHIBHAVA CLAIMS DETAILS</div><br/>
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
<th>MONTH</th>
<th>TOTAL NUMBER OF DEATH MEMBERS </th>
<th>TOTAL AMOUNT</th>
</tr>
<tr>
<th><%=Y2 %></th>
...
<div align="center" style="text-decoration:underline;font-size:12pt;font-family:calibri;text-decoration:underline;font-size:12pt;color:black;font-weight:bold;">ANNUM LIST OF SUKHIBHAVA CLAIMS DETAILS</div><br/>
<table border="1" bordercolor="black" align="center">
<tr bgcolor="yellow">
<th>ANNUM</th>
<th>TOTAL NUMBER OF DEATH MEMBERS </th>
