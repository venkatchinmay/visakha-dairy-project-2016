...
<title>WITH HELP PRICE TERM ENTRY PANEL CHECK</title>
...
<div id="body">
<form name = "myform"  action = "WithhelpprisetermoneDatabaseentry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:310px;">WITH HELP PRICE ENTRY(TERM WISE)</u></font></div>
...
<tr>
<th colspan="2" class="h">WITH HELP PRISE 1ST TERM ENTRY</th>
</tr>
<tr>
...
<tr>
<th class="n">DATE OF TERM ENTRY</th>
...
<div><a href="http://localhost:8080/Dairy/withhelpprisetermentry1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
