...
<div id="body">
<form name = "myform"  action = "WithhelpprisetermtwoDatabaseentry" method = "post">
...
<tr>
<th colspan="2" class="h">WITH HELP PRISE 2ND TERM ENTRY</th>
</tr>
<tr>
...
<div><a href="withhelpprisetermentry2.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
