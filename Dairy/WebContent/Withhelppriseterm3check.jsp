...
<title>WITH HELP PRISE TERM ENTRY PANEL CHECK</title>
...
<div id="body">
<form name = "myform"  action = "WithhelpprisetermthreeDatabaseentry" method = "post">
<div style="margin-top:20pt;margin-bottom:20pt"><font face="Agency FB" size="+8" 
><u style="color:#006400;position:relative;left:310px;">WITH HELP PRISE ENTRY(TERM WISE)</u></font></div>
...
<tr>
<th colspan="2" class="h">WITH HELP PRISE 3RD TERM ENTRY</th>
</tr>
<tr>
...
<div><a href="withhelpprisetermentry3.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
