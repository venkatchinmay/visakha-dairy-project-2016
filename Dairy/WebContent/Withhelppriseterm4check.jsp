...
<div id="body">
<form name = "myform"  action = "WithhelpprisetermfourDatabaseentry" method = "post">
...
<tr>
<th colspan="2" class="h">WITH HELP PRISE 4TH TERM ENTRY</th>
</tr>
<tr>
...
<div><a href="withhelpprisetermentry4.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
