...
<div id="body">
<form name = "myform"  action = "WithhelppriseexpendituredecemberDataBaseentry1" method = "post">
...
<tr>
<th colspan="2" class="h">WITH HELP PRISE EXPENDITURE DECEMBER ENTRY </th>
</tr>
<tr>
...
<div><a href="withhelppriseexpendituredecemberentry1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
