...
<div id="body">
<form name = "myform"  action = "WithhelppriseexpendituremayDataBaseentry1" method = "post">
...
<tr>
<th colspan="2" class="h">WITH HELP PRICE EXPENDITURE MAY ENTRY </th>
</tr>
<tr>
...
<div><a href="withhelppriseexpendituremayentry1.html"><input style="float:left;clear:left;position:relative;left:200px;margin:15px" type="button" value="Modify WITHHELPPRISE Details"/></a>
